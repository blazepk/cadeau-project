...
function Contact() {
  return (
    <div className="grid grid-cols-12 bg-white w-full">
      <div className="min-h-[100px] rounded  bg-yellow-700 w-full shadow-xl text-white  col-span-7">
        <div className="p-4 text-center flex flex-col justify-around h-full">
          ...
          <div className="flex flex-col gap-y-3">
            <div className="">+91 123456789</div>
            <div className="">
              <span className="font-bold">Email</span> : Contact@gmail.com
            </div>
            <div className="">
              <span className="font-bold">Address</span>:222,thane,Mumbai India
            </div>
          </div>
      ...
      <div className="bg-white min-h-[100px] rounded w-full shadow-xl  text-gray-600 col-span-5 p-5">
        <form action="" className="flex flex-col space-y-4">
          ...
          <div className="flex items-center justify-center">
            <button className="inline-block self-end bg-yellow-700 text-white font-bold rounded-lg px-6 py-2 uppercase-sm">
              Send Message
            </button>
          </div>
        </form>
