...
const Footer1 = () => {
  return (
    ...
    <footer className="w-full bg-brown-900 text-white py-6 ">
       <div className="container mx-auto flex flex-col items-center md:flex-row gap-0 justify-between  px-4  ">
        ...
        <div className='flex space-x-6 text-center'>
          ...
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-300 rounded-lg  md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0  ">
           ...
           <li>
             <NavLink to ="/"
               className={({isActive}) => 
                 `font-bold block py-2 px-3 text-blue rounded ${isActive ? "text-orange" : "text-blue"} hover:bg-gray-300 md:hover:bg-transparent md:border-0 md:hover:text-yellow md:p-0 "
               aria-current="page"`} >
